...
class AllWarrantyDataTable extends DataTable
{
    ...
    {
        $cacheKey = config('dbcachekey.warranty');
        $data = Cache::rememberForever($cacheKey, function () use ($model) {
        ...
        return $model->newQuery()->with('productInfo')->whereIn('id', $ids)->orderBy('id', 'desc');
    }
