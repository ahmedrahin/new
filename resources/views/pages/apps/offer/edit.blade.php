<x-default-layout>
    ...
    @section('breadcrumbs')
    {{ Breadcrumbs::render('editoffer', $data->id) }}
    @endsection
    ...
    <div id="errors">
     ...
     <form class="form" id="add_form" enctype="multipart/form-data" action="{{ route('offer.update', $data->id) }}">
        @csrf
        <div class="">
            <!--begin::Order details-->
                    ...
                    <div class="d-flex flex-column gap-5 gap-md-7">
                        ...
                        <div class="d-flex flex-column flex-md-row gap-5">
                            <div class="fv-row flex-row-fluid">
                                ...
                                <input class="form-control" name="title" placeholder="Offer Tittle" value="{{ $data->title }}" />
                        ...
                        <div class="d-flex flex-column flex-md-row gap-5">
                            <div class="fv-row flex-row-fluid">
                                ...
                                <input class="form-control" name="descrip" placeholder="Sub Title" value="{{ $data->descrip }}" />
                        ...
                        <div class="d-flex flex-column flex-md-row gap-5">
                            <div class="fv-row flex-row-fluid">
                                ...
                                <input placeholder="Select a date" name="start_at" class="form-control dateFick mb-2" value="{{ $data->start_at }}" />
                            ...
                            <div class="flex-row-fluid">
                                ...
                                <input placeholder="Select a date" name="expire_date"
                                    class="form-control dateFick mb-2" value="{{ $data->expire_date }}" />
                        ...
                        <div>
                            ...
                            <textarea name="details" id="editor" style="width: 100%;height: 350px;">{!! $data->details !!}</textarea>
                        </div>
                                            ...
                                            <div class="product-item row g-3 mb-3">
                                                ...
                                                <div class="col-md-6 mb-2">
                                                    <input type="text" name="link_title[]" class="form-control"
                                                        placeholder="Enter a title" value="{{ $link->title }}">
                                                </div>

                                                <div class="col-md-6 mb-2">
                                                    <div class="d-flex align-items-center">
                                                        <input type="text" name="link[]" class="form-control"
                                                            placeholder="Link" value="{{ $link->link }}">
                                                        @if (!$loop->first)
