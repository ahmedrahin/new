...
<section class="after-header p-tb-10">
    <div class="container c-intro">
        <ul class="breadcrumb">
            ...
            <li><a href="{{ route('category.product',$category->subcategory->category->slug) }}"><span>{{ $category->subcategory->category->name }}</span></a>
            <li><a href="{{ route('subcategory.product', [$category->subcategory->category->slug, $category->subcategory->slug]) }}"><span>{{ $category->subcategory->name }}</span></a>
            <li><a href="{{ route('subsubcategory.product', [$category->subcategory->category->slug, $category->subcategory->slug, $category->slug]) }}"><span>{{ $category->name }}</span></a>
            </li>
        </ul>
        <h1></h1>
        <p>
