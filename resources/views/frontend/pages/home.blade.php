    ...
    <main id="wrapper">
                    ...
                    <div class="col-xl-6 d-none d-xl-block">
                        <nav class="box-navigation">
                            <ul class="box-nav-menu">
                                            ...
                                            <div class="row">
                                                <div class="col-2">
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="sub-menu_list">
                                                            ...
                                                            <li><a href="shop-2-columns.html" class="sub-menu_link">Shop 2 Columns</a></li>
                                                            <li><a href="shop-3-columns.html" class="sub-menu_link">Shop 3 Columns</a></li>
                                                            <li><a href="shop-4-columns.html" class="sub-menu_link">Shop 4 Columns</a></li>
                                                            <li><a href="shop-5-columns.html" class="sub-menu_link">Shop 5 Columns</a></li>
                                                            <li><a href="shop-6-columns.html" class="sub-menu_link">Shop 6 Columns</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-2">
                                                ...
                                                <div class="col-2">
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="sub-menu_list">
                                                            <li><a href="shop-hover-01.html" class="sub-menu_link">Hover Style 01</a></li>
                                                            <li><a href="shop-hover-02.html" class="sub-menu_link">Hover Style 02</a></li>
                                                            <li><a href="shop-hover-03.html" class="sub-menu_link">Hover Style 03</a></li>
                                                            <li><a href="shop-hover-04.html" class="sub-menu_link">Hover Style 04</a></li>
                                                            <li><a href="shop-hover-05.html" class="sub-menu_link">Hover Style 05</a></li>
                                                            <li><a href="shop-hover-06.html" class="sub-menu_link">Hover Style 06</a></li>
                                                            <li><a href="shop-hover-07.html" class="sub-menu_link">Hover Style 07</a></li>
                                                            <li><a href="shop-hover-08.html" class="sub-menu_link">Hover Style 08</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <ul class="list-hor">
                                                        <li class="wg-cls hover-img">
                                                            ...
                                                            <div class="cls-content">
                                                                ...
                                                                <a href="shop-default.html" class="tf-btn-line"> Shop now </a>
                                                            </div>
                                                        </li>
                                                        <li class="wg-cls hover-img">
                                                            <a href="shop-default.html" class="image img-style">
                                ...
                                <li class="menu-item">
                                    <a href="#" class="item-link">PRODUCT<i class="icon icon-caret-down"></i></a>
                                    <div class="sub-menu mega-menu">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-2">
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="sub-menu_list">
                                                            ...
                                                            <li>
                                                                <a href="product-left-thumbnail.html" class="sub-menu_link">Product Left Thumbnail</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-right-thumbnail.html" class="sub-menu_link">Product Right
                                                                    Thumbnail</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-bottom-thumbnail.html" class="sub-menu_link">Product Bottom
                                                                    Thumbnail</a>
                                                            </li>
                                                ...
                                                <div class="col-2">
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="sub-menu_list">
                                                            <li>
                                                                <a href="product-frequently-bought-together.html" class="sub-menu_link">Buy
                                                                    Together</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-often-purchased-together.html" class="sub-menu_link">Often Purchased
                                                                    Together</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-countdown-timer.html" class="sub-menu_link">Countdown Timer</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-volume-discount.html" class="sub-menu_link">Volume Discount</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-volume-discount-thumbnail.html" class="sub-menu_link">Volume Discount
                                                                    Thumbnail</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-swatch-dropdown.html" class="sub-menu_link">Swatch Dropdown</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-swatch-dropdown-color.html" class="sub-menu_link">Swatch Dropdown
                                                                    Color</a>
                                                            </li>
                                                            <li><a href="product-swatch-image.html" class="sub-menu_link">Swatch Image</a></li>
                                                            <li>
                                                                <a href="product-swatch-image-square.html" class="sub-menu_link">Swatch Image
                                                                    Retangle</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                ...
                                                <div class="col-2">
                                                    <div class="mega-menu-item">
                                                        ...
                                                        <ul class="sub-menu_list">
                                                            <li>
                                                                <a href="product-description-accordion.html" class="sub-menu_link">Product Description
                                                                    Accordion</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-description-list.html" class="sub-menu_link">Product Description
                                                                    List</a>
                                                            </li>
                                                            <li>
                                                                <a href="product-description-vertical.html" class="sub-menu_link">Product Description
                                                                    Vertical</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                        ...
                                                        <ul class="list-ver">
                                                            <li class="prd-recent hover-img">
                                                                ...
                                                                <div class="content">
                                                                    ...
                                                                    <span class="price-wrap h6 fw-semibold text-black"> $69,99 </span>
                                                                </div>
                                                            </li>
                                                            <li class="br-line"></li>
                                                            <li class="prd-recent hover-img">
                                ...
                                <li class="menu-item position-relative">
                                    <a href="#" class="item-link">PAGE<i class="icon icon-caret-down"></i></a>
                                    <div class="sub-menu">
                                        <ul class="sub-menu_list">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="slider-wrap">
                            <div class="sld_image">
                                <img src="images/slider/slider-1.jpg" data-src="images/slider/slider-1.jpg" alt="Image" class="lazyload">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="slider-wrap">
                            <div class="sld_image">
                                <img src="images/slider/slider-2.jpg" data-src="images/slider/slider-2.jpg" alt="Image" class="lazyload">
                            </div>
                            <div class="sld_content">
                                <div class="container">
                                    <div class="content-sld_wrap">
                    ...
                    <div class="swiper-slide">
                        <div class="slider-wrap">
                            <div class="sld_image">
                                <img src="images/slider/slider-3.jpg" data-src="images/slider/slider-3.jpg" alt="Image" class="lazyload">
                            </div>
                            <div class="sld_content">
                                <div class="container">
                                    <div class="content-sld_wrap">
                                        <h1 class="title_sld text-display fade-item fade-item-1">Urban Edge <br class="d-sm-none">Series</h1>
                                        <p class="sub-text_sld h5 text-black fade-item fade-item-2">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="wg-cls-2 d-flex hover-img">
                            <a href="shop-default.html" class="image img-style">
                                <img class="lazyload" src="images/collections/cls-1.jpg" data-src="images/collections/cls-1.jpg" alt="Slider">
                            </a>
                    ...
                    <div class="swiper-slide">
                        <div class="wg-cls-2 d-flex hover-img">
                            <a href="shop-default.html" class="image img-style">
                                <img class="lazyload" src="images/collections/cls-2.jpg" data-src="images/collections/cls-2.jpg" alt="Slider">
                            </a>
                            <div class="cls-content_wrap b-16">
                                <div class="cls-content">
                    ...
                    <div class="swiper-slide">
                        <div class="wg-cls-2 d-flex hover-img">
                            <a href="shop-default.html" class="image img-style">
                                <img class="lazyload" src="images/collections/cls-3.jpg" data-src="images/collections/cls-3.jpg" alt="Slider">
                            </a>
                            <div class="cls-content_wrap b-16">
                                <div class="cls-content">
            ...
            <div class="container">
                ...
                <div class="tab-content">
                    <div class="tab-pane active show" id="trending" role="tabpanel">
                        <div dir="ltr" class="swiper tf-swiper wrap-sw-over wow fadeInUp" data-preview="4" data-tablet="3" data-mobile-sm="2" data-mobile="2" data-space-lg="48" data-space-md="30" data-space="12" data-pagination="2" data-pagination-sm="2" data-pagination-md="3"
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    ...
                                                    <span class="swatch-value bg-light-beige"></span>
                                                    <img class="lazyload" src="images/products/product-23.jpg" data-src="images/products/product-23.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Dark</span>
                                                    <span class="swatch-value bg-dark-charcoal"></span>
                                                    <img class="lazyload" src="images/products/product-25.jpg" data-src="images/products/product-25.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Sage Green</span>
                                                    <span class="swatch-value bg-sage-green"></span>
                                                    <img class="lazyload" src="images/products/product-26.jpg" data-src="images/products/product-26.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    <span class="tooltip color-filter">Dark</span>
                                                    <span class="swatch-value bg-dark-charcoal"></span>
                                                    <img class="lazyload" src="images/products/product-33.jpg" data-src="images/products/product-33.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Beige</span>
                                                    <span class="swatch-value bg-light-beige"></span>
                                                    <img class="lazyload" src="images/products/product-35.jpg" data-src="images/products/product-35.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Jade</span>
                                                    <span class="swatch-value bg-dark-jade"></span>
                                                    <img class="lazyload" src="images/products/product-36.jpg" data-src="images/products/product-36.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    ...
                                                    <img class="lazyload" src="images/products/product-37.jpg" data-src="images/products/product-37.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Pink</span>
                                                    <span class="swatch-value bg-hot-pink"></span>
                                                    <img class="lazyload" src="images/products/product-39.jpg" data-src="images/products/product-39.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Beige</span>
                                                    <span class="swatch-value bg-light-beige"></span>
                                                    <img class="lazyload" src="images/products/product-40.jpg" data-src="images/products/product-40.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    <span class="tooltip color-filter">Beige</span>
                                                    <span class="swatch-value bg-light-beige"></span>
                                                    <img class="lazyload" src="images/products/product-41.jpg" data-src="images/products/product-41.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Black</span>
                                                    <span class="swatch-value bg-black"></span>
                                                    <img class="lazyload" src="images/products/product-43.jpg" data-src="images/products/product-43.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Violet</span>
                                                    <span class="swatch-value bg-muted-violet"></span>
                                                    <img class="lazyload" src="images/products/product-44.jpg" data-src="images/products/product-44.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div class="tab-pane" id="best-seller" role="tabpanel">
                        <div dir="ltr" class="swiper tf-swiper wrap-sw-over" data-preview="4" data-tablet="3" data-mobile-sm="2" data-mobile="2" data-space-lg="48" data-space-md="30" data-space="12" data-pagination="2" data-pagination-sm="2" data-pagination-md="3" data-pagination-lg="4"
                            data-grid="2">
                            <div class="swiper-wrapper">
                                <!-- Product 1 -->
                                <div class="swiper-slide">
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    <span class="tooltip color-filter">Sage Green</span>
                                                    <span class="swatch-value bg-sage-green"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-1.jpg" data-src="images/products/underwear/product-1.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Light Orange</span>
                                                    <span class="swatch-value bg-tomato"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-3.jpg" data-src="images/products/underwear/product-3.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    <span class="tooltip color-filter">Beige</span>
                                                    <span class="swatch-value bg-light-beige"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-4.jpg" data-src="images/products/underwear/product-4.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Dark</span>
                                                    <span class="swatch-value bg-dark-charcoal"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-6.jpg" data-src="images/products/underwear/product-6.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Green</span>
                                                    <span class="swatch-value bg-dark-jade"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-7.jpg" data-src="images/products/underwear/product-7.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    ...
                                                    <span class="swatch-value bg-dusty-olive"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-8.jpg" data-src="images/products/underwear/product-8.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Light Orange</span>
                                                    <span class="swatch-value bg-tomato"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-10.jpg" data-src="images/products/underwear/product-10.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Green</span>
                                                    <span class="swatch-value bg-dark-jade"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-11.jpg" data-src="images/products/underwear/product-11.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    <span class="tooltip color-filter">Green</span>
                                                    <span class="swatch-value bg-dark-jade"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-12.jpg" data-src="images/products/underwear/product-12.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Dusty Olive</span>
                                                    <span class="swatch-value bg-dusty-olive"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-14.jpg" data-src="images/products/underwear/product-14.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    <span class="tooltip color-filter">White</span>
                                                    <span class="swatch-value bg-white"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-15.jpg" data-src="images/products/underwear/product-15.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Light Orange</span>
                                                    <span class="swatch-value bg-tomato"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-17.jpg" data-src="images/products/underwear/product-17.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Dark</span>
                                                    <span class="swatch-value bg-dark-charcoal"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-18.jpg" data-src="images/products/underwear/product-18.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    <span class="tooltip color-filter">Beige</span>
                                                    <span class="swatch-value bg-light-beige"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-19.jpg" data-src="images/products/underwear/product-19.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    ...
                                                    <img class="lazyload" src="images/products/underwear/product-21.jpg" data-src="images/products/underwear/product-21.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Dark Violet</span>
                                                    <span class="swatch-value bg-muted-violet"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-23.jpg" data-src="images/products/underwear/product-23.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Sage Green</span>
                                                    <span class="swatch-value bg-sage-green"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-24.jpg" data-src="images/products/underwear/product-24.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Hot Pink</span>
                                                    <span class="swatch-value bg-hot-pink"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-25.jpg" data-src="images/products/underwear/product-25.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    <span class="tooltip color-filter">Dark</span>
                                                    <span class="swatch-value bg-dark-charcoal"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-26.jpg" data-src="images/products/underwear/product-26.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Purple</span>
                                                    <span class="swatch-value bg-light-purple"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-28.jpg" data-src="images/products/underwear/product-28.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Sage Green</span>
                                                    <span class="swatch-value bg-sage-green"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-29.jpg" data-src="images/products/underwear/product-29.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">White</span>
                                                    <span class="swatch-value bg-white"></span>
                                                    <img class="lazyload" src="images/products/underwear/product-30.jpg" data-src="images/products/underwear/product-30.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <div class="themesFlat">
            <div class="container-full">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8">
                        <div dir="ltr" class="swiper tf-swiper wrap-sw-over wow fadeInUp" data-preview="3" data-tablet="3" data-mobile-sm="2" data-mobile="2" data-space-lg="48" data-space-md="30" data-space="12" data-pagination="2" data-pagination-sm="2" data-pagination-md="3"
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot active">
                                                    <span class="tooltip color-filter">Beige</span>
                                                    <span class="swatch-value bg-light-beige"></span>
                                                    <img class="lazyload" src="images/products/product-27.jpg" data-src="images/products/product-27.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Violet</span>
                                                    <span class="swatch-value bg-muted-violet"></span>
                                                    <img class="lazyload" src="images/products/product-29.jpg" data-src="images/products/product-29.jpg" alt="Product">
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-product_info">
                                            ...
                                            <ul class="product-color_list">
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Beige</span>
                                                    <span class="swatch-value bg-light-beige"></span>
                                                    <img class="lazyload" src="images/products/product-30.jpg" data-src="images/products/product-30.jpg" alt="Product">
                                                </li>
                                                <li class="product-color-item color-swatch hover-tooltip tooltip-bot">
                                                    <span class="tooltip color-filter">Dark</span>
                                                    <span class="swatch-value bg-dark-charcoal"></span>
                                                    <img class="lazyload" src="images/products/product-32.jpg" data-src="images/products/product-32.jpg" alt="Product">
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-V01 wow fadeInLeft">
                                <div class="">
                                    ...
                                    <p class="tes_text h4">
                                        “The build quality is excellent and everything works smoothly. I can feel the difference compared to other brands“
                                    </p>
                                ...
                                <div class="tes_product">
                                    <div class="product-image">
                                        <img class="lazyload" src="images/products/product-35.jpg" data-src="images/products/product-35.jpg" alt="Short Sleeve Office Shirt">
                                    </div>
                                    <div class="product-infor">
                                        <h5 class="prd_name">
                                            <a href="product-detail.html" class="link"> Short sleeve office shirt </a>
                                        </h5>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-V01 wow fadeInLeft" data-wow-delay="0.1s">
                                ...
                                <div class="tes_product">
                                    <div class="product-image">
                                        <img class="lazyload" src="images/products/product-40.jpg" data-src="images/products/product-40.jpg" alt="UrbanCool Work Shirt">
                                    </div>
                                    <div class="product-infor">
                                        <h5 class="prd_name">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-V01 wow fadeInLeft" data-wow-delay="0.2s">
                                ...
                                <div class="tes_product">
                                    <div class="product-image">
                                        <img class="lazyload" src="images/products/product-13.jpg" data-src="images/products/product-13.jpg" alt="UrbanCool Work Shirt">
                                    </div>
                                    <div class="product-infor">
                                        <h5 class="prd_name">
        ...
        <div class="flat-spacing">
            <div class="container">
                ...
                <div dir="ltr" class="swiper tf-swiper" data-preview="4" data-tablet="3" data-mobile-sm="2" data-mobile="1" data-space-lg="48" data-space-md="24" data-space="12" data-pagination="1" data-pagination-sm="2" data-pagination-md="3" data-pagination-lg="4">
                    <div class="swiper-wrapper">
                        <!-- item 1 -->
                        <div class="swiper-slide">
                            <div class="article-blog type-space-2 hover-img4 wow fadeInLeft">
                                <a href="blog-detail.html" class="entry_image img-style4">
                                    <img src="images/blog/blog-1.jpg" data-src="images/blog/blog-1.jpg" alt="Image" class="lazyload aspect-ratio-0">
                                </a>
                                <div class="entry_tag">
                        ...
                        <div class="swiper-slide">
                            <div class="article-blog type-space-2 hover-img4 wow fadeInLeft" data-wow-delay="0.1s">
                                <a href="blog-detail.html" class="entry_image img-style4">
                                    <img src="images/blog/blog-2.jpg" data-src="images/blog/blog-2.jpg" alt="Image" class="lazyload aspect-ratio-0">
                                </a>
                                <div class="entry_tag">
                                    <a href="blog-grid.html" class="name-tag h6 link">March 2, 2025</a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="article-blog type-space-2 hover-img4 wow fadeInLeft" data-wow-delay="0.2s">
                                <a href="blog-detail.html" class="entry_image img-style4">
                                    <img src="images/blog/blog-3.jpg" data-src="images/blog/blog-3.jpg" alt="Image" class="lazyload aspect-ratio-0">
                                </a>
                                <div class="entry_tag">
                                    <a href="blog-grid.html" class="name-tag h6 link">March 2, 2025</a>
                                </div>
                        ...
                        <div class="swiper-slide">
                            <div class="article-blog type-space-2 hover-img4 wow fadeInLeft" data-wow-delay="0.3s">
                                <a href="blog-detail.html" class="entry_image img-style4">
                                    <img src="images/blog/blog-4.jpg" data-src="images/blog/blog-4.jpg" alt="Image" class="lazyload aspect-ratio-0">
                                </a>
                                <div class="entry_tag">
                                    <a href="blog-grid.html" class="name-tag h6 link">March 2, 2025</a>
                                </div>
        ...
        <section class="flat-spacing pt-0 pb-xl-0">
            ...
            <div dir="ltr" class="swiper tf-swiper wow fadeInUp" data-preview="6" data-tablet="4" data-mobile-sm="3" data-mobile="2" data-space="0" data-pagination="2" data-pagination-sm="3" data-pagination-md="4" data-pagination-lg="6">
                <div class="swiper-wrapper">
                    <!-- item 1 -->
                    <div class="swiper-slide">
                        <div class="gallery-item hover-img hover-overlay">
                            <div class="image img-style">
                                <img class="lazyload" src="images/gallery/gallery-1.jpg" data-src="images/gallery/gallery-1.jpg" alt="Image">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-item hover-img hover-overlay">
                            <div class="image img-style">
                                <img class="lazyload" src="images/gallery/gallery-2.jpg" data-src="images/gallery/gallery-2.jpg" alt="Image">
                            </div>
                            <a href="product-detail.html" class="box-icon hover-tooltip">
                                <span class="icon icon-instagram-logo"></span>
                                <span class="tooltip">View product</span>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-item hover-img hover-overlay">
                            <div class="image img-style">
                                <img class="lazyload" src="images/gallery/gallery-3.jpg" data-src="images/gallery/gallery-3.jpg" alt="Image">
                            </div>
                            <a href="product-detail.html" class="box-icon hover-tooltip">
                                <span class="icon icon-instagram-logo"></span>
                                <span class="tooltip">View product</span>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-item hover-img hover-overlay">
                            <div class="image img-style">
                                <img class="lazyload" src="images/gallery/gallery-4.jpg" data-src="images/gallery/gallery-4.jpg" alt="Image">
                            </div>
                            <a href="product-detail.html" class="box-icon hover-tooltip">
                                <span class="icon icon-instagram-logo"></span>
                                <span class="tooltip">View product</span>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-item hover-img hover-overlay">
                            <div class="image img-style">
                                <img class="lazyload" src="images/gallery/gallery-5.jpg" data-src="images/gallery/gallery-5.jpg" alt="Image">
                            </div>
                            <a href="product-detail.html" class="box-icon hover-tooltip">
                                <span class="icon icon-instagram-logo"></span>
                                <span class="tooltip">View product</span>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery-item hover-img hover-overlay">
                            <div class="image img-style">
                                <img class="lazyload" src="images/gallery/gallery-6.jpg" data-src="images/gallery/gallery-6.jpg" alt="Image">
                            </div>
                            <a href="product-detail.html" class="box-icon hover-tooltip">
                                <span class="icon icon-instagram-logo"></span>
                                <span class="tooltip">View product</span>
                                ...
                                <div class="tf-collapse-content">
                                    <ul class="footer-contact">
                                        <li>
                                            ...
                                            <span class="br-line"></span>
                                            <a href="https://www.google.com/maps?q=8500+Lorem+Street+Chicago,+IL+55030+Dolor+sit+amet" target="_blank" class="h6 link">
                                            ...
                                            <div class="checkbox-wrap">
                                                ...
                                                <label for="remember" class="h6">
                                                    ...
                                                    <a href="faq.html" class="text-decoration-underline link">Terms
                                                        of Service</a> and <a href="faq.html" class="text-decoration-underline link">
                                                        Privacy Policy</a>.
                                                </label>
                                            </div>
                        ...
                        <div class="tf-compare-offcanvas list-empty">
                            ...
                            <div class="tf-compare-item file-delete">
                                <a href="product-detail.html">
                                    ...
                                    <img class="radius-3 lazyload" data-src="images/products/product-1.jpg" src="images/products/product-1.jpg" alt="Image">
                                </a>
                            </div>
                            <div class="tf-compare-item file-delete">
                                <a href="product-detail.html">
                                    ...
                                    <img class="radius-3 lazyload" data-src="images/products/product-5.jpg" src="images/products/product-5.jpg" alt="Image">
                                </a>
                            </div>
                            <div class="tf-compare-item file-delete">
                                <a href="product-detail.html">
                                    ...
                                    <img class="radius-3 lazyload" data-src="images/products/product-7.jpg" src="images/products/product-7.jpg" alt="Image">
                                </a>
                            </div>
                        </div>
                        <div class="tf-compare-buttons">
                            <a href="compare.html" class="tf-btn animate-btn d-inline-flex bg-dark-2 justify-content-center"> Compare </a>
                    ...
                    <div dir="ltr" class="swiper tf-single-slide">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" data-size="XS" data-color="beige">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/product-9.jpg" src="images/products/product-9.jpg" alt="Image">
                                </div>
                            </div>
                            <div class="swiper-slide" data-size="L" data-color="pink">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/product-39.jpg" src="images/products/product-39.jpg" alt="Image">
                                </div>
                            </div>
                            <div class="swiper-slide" data-size="M" data-color="green">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/product-1.jpg" src="images/products/product-1.jpg" alt="Image">
                                </div>
                            </div>
                            <div class="swiper-slide" data-size="S" data-color="blue">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/product-4.jpg" src="images/products/product-4.jpg" alt="Image">
                                </div>
                            </div>
                            <div class="swiper-slide" data-size="L" data-color="black">
                                <div class="item">
                                    <img class="lazyload" data-src="images/products/product-47.jpg" src="images/products/product-47.jpg" alt="Image">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tf-product-info-wrap">
                    <div class="tf-product-info-inner tf-product-info-list">
                        <div class="tf-product-info-heading">
                            <a href="product-detail.html" class="link product-info-name fw-medium h1"> Casual Round Neck T-Shirt </a>
                            ...
                            <p class="product-infor-sub text-main h6">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse justo dolor, consectetur vel metus vitae, tincidunt finibus dui fusce tellus enim.
                            </p>
                        </div>
                        ...
                        <div class="tf-product-total-quantity w-100">
                            ...
                            <div class="group-btn flex-sm-nowrap">
                                ...
                                <a href="#compare" data-bs-toggle="offcanvas" class="d-none d-sm-flex hover-tooltip tooltip-top box-icon flex-sm-shrink-0">
                                    <span class="icon icon-compare"></span>
                                    <span class="tooltip">Compare</span>
                                </a>
                            </div>
                            ...
                            <div class="group-btn justify-content-center">
                                <a href="#" class="tf-btn-line text-normal letter-space-0 fw-normal"> More payment options </a>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div>
                    <form class="form-search style-2">
                        <fieldset>
                            <input type="text" placeholder="Search item" class="style-stroke" name="text" tabindex="0" value="" aria-required="true" required="">
                        </fieldset>
            ...
            <div class="wrap-recommendations">
                <div class="list-cart">
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="images/products/product-11.jpg" src="images/products/product-11.jpg" alt="Image">
                        </div>
                        <div class="content">
                            <h6 class="name">
                    ...
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="images/products/product-13.jpg" src="images/products/product-13.jpg" alt="Image">
                        </div>
                        <div class="content">
                            <h6 class="name">
                    ...
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="images/products/product-15.jpg" src="images/products/product-15.jpg" alt="Image">
                        </div>
                        <div class="content">
                            <h6 class="name">
                    ...
                    <div class="list-cart-item">
                        <div class="image">
                            <img class="lazyload" data-src="images/products/product-17.jpg" src="images/products/product-17.jpg" alt="Image">
                        </div>
                        <div class="content">
                            <h6 class="name">
                            ...
                            <div class="tf-mini-cart-items list-empty">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img class="lazyload" data-src="images/products/product-1.jpg" src="images/products/product-1.jpg" alt="img-product">
                                    </div>
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img class="lazyload" data-src="images/products/product-2.jpg" src="images/products/product-2.jpg" alt="img-product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="text-small text-main-2 sub">T-shirt</div>
                                        <h6 class="title">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img class="lazyload" data-src="images/products/product-3.jpg" src="images/products/product-3.jpg" alt="img-product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="text-small text-main-2 sub">Sweatshirt</div>
                                        <h6 class="title">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <img class="lazyload" data-src="images/products/product-4.jpg" src="images/products/product-4.jpg" alt="img-product">
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="text-small text-main-2 sub">Shorts</div>
                                        <h6 class="title">
                    ...
                    <div class="tf-mini-cart-bottom box-empty_clear">
                        ...
                        <div class="tf-mini-cart-bottom-wrap">
                            ...
                            <div class="free-shipping">
                                <i class="icon icon-truck"></i> Free shipping on all orders over $150
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tf-mini-cart-tool-openable estimate-shipping">
                        ...
                        <form id="shipping-form" class="tf-mini-cart-tool-content">
                            <div class="tf-mini-cart-tool-text h5 fw-semibold">
                                <i class="icon icon-truck"></i> Shipping
                            </div>
                            <div class="field">
                                <div class="tf-select">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content p-0">
                <div class="modal-heading">
                    <div class="image">
                        <img class="lazyload" src="images/section/newletter.jpg" data-src="images/section/newletter.jpg" alt="Image">
                    </div>
                    ...
                    <div class="sib-form sib-form_newletter">
                        <div id="sib-form-container" class="sib-form-container">
                            ...
                            <div id="sib-container" class="sib-container--large sib-container--vertical">
                                <form id="sib-form" method="POST" action="https://3c02c1a1.sibforms.com/serve/MUIFAFPRWVlRk-kE9iHdv65Y3rsuzYBfqoHBiXUsxCq5iy1P50mAUPMZ2OmfFABASDBPu6E1XohUSGXfD1t2Yt26U0dKm6QZOZZHtdQdVwYPU0ho_4_v86gRaeSEiKTYre80--XhZYCeo13DP6aZboCZ-f0MxfoIv8ph2pGSdcIYZtSh6bAMsJZA0QSlWkLxoErZqGHpYO3naKhz"
                                            ...
                                            <div class="form__entry entry_block">
                                                <div class="form__label-row ">
                                                    ...
                                                    <div class="entry__field">
                                                        <input class="input style-stroke" type="text" id="EMAIL" name="EMAIL" autocomplete="off" placeholder="Enter your email" data-required="true" required>
                                                    </div>
                                                </div>
                                    ...
                                    <div>
                                        <div class="sib-form-block">
                                            <button class="sib-form-block__button sib-form-block__button-with-loader tf-btn w-100 animate-btn" form="sib-form" type="submit">
