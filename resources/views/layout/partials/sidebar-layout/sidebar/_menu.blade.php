...
<div class="app-sidebar-menu overflow-hidden flex-column-fluid">
    ...
    <div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true"
        ...
        <div class="menu menu-column menu-rounded menu-sub-indention px-3 fw-semibold fs-6" id="#kt_app_sidebar_menu"
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('warranty*') || request()->routeIs('all.warranty') ? 'here show' : '' }}">
                <!--begin:Menu link-->
                <span class="menu-link">
                ...
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link {{ request()->routeIs('warranty.create') ? 'active' : '' }}"
                            href="{{ route('warranty.create') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Create Warranty</span>
                        </a>
                        <a class="menu-link {{ request()->routeIs('warranty.index', [date('Y'), \Carbon\Carbon::now()->format('M')]) ? 'active' : '' }}"
                            href="{{ route('warranty.index', [date('Y'), \Carbon\Carbon::now()->format('M')]) }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Monthly Warranties</span>
                        </a>
                        <a class="menu-link {{ request()->routeIs('all.warranty') ? 'active' : '' }}"
                            href="{{ route('all.warranty') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">All Warranties List</span>
                        </a>
                    </div>
                </div>
            ...
            <div data-kt-menu-trigger="click"
                class="menu-item menu-accordion {{ request()->routeIs('service*') ? 'here show' : '' }}">
                <!--begin:Menu link-->
                <span class="menu-link">
                ...
                <div class="menu-sub menu-sub-accordion">
                    <div class="menu-item">
                        <a class="menu-link {{ request()->routeIs('service.create') ? 'active' : '' }}"
                            href="{{ route('service.create') }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Create Servicing</span>
                        </a>
                        <a class="menu-link {{ request()->routeIs('service.index', [date('Y'), \Carbon\Carbon::now()->format('M')]) ? 'active' : '' }}"
                            href="{{ route('service.index', [date('Y'), \Carbon\Carbon::now()->format('M')]) }}">
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                            <span class="menu-title">Servicing List</span>
                        </a>
                    </div>
                </div>
            </div>
